...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_console_component_1 = __webpack_require__(168);
	...
	var EchoConsole = (function (_super) {
	    ...
	    EchoConsole.prototype.render = function () {
	        var _this = this;
	        return React.createElement(react_console_component_1.default, {ref: function (ref) { return _this.child.console = ref; }, handler: this.echo, promptLabel: this.promptLabel, autofocus: true});
	    };
	    return EchoConsole;
	}(React.Component));
	function init(element) {
	    ReactDOM.render(React.createElement(EchoConsole, null), element);
	}
	exports.init = init;
		    ...
		    function default_1(props) {
		        ...
		        this.rotateHistory = function (n) {
		            if (_this.state.history.length == 0)
		                return;
		            var ringn = _this.state.ringn - n;
		            if (ringn < 0) {
		                ringn = 0;
		            }
		            else if (ringn > _this.state.history.length) {
		                ringn = _this.state.history.length;
		            }
		            if (ringn == 0) {
		                _this.setState({
		                ...
		                var promptText = _this.state.history[_this.state.history.length - ringn];
		                _this.setState({
		                    promptText: promptText,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var warning = __webpack_require__(10);
	var canDefineProperty = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstrumentation = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  var ReactInvalidSetStateWarningDevTool = __webpack_require__(184);
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(185);
	  var ReactComponentTreeDevtool = __webpack_require__(186);
	  ReactDebugTool.addDevtool(ReactInvalidSetStateWarningDevTool);
	  ReactDebugTool.addDevtool(ReactComponentTreeDevtool);
	  ReactDebugTool.addDevtool(ReactNativeOperationHistoryDevtool);
	  var url = ExecutionEnvironment.canUseDOM && window.location.href || '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponent = __webpack_require__(180);
	var ReactElement = __webpack_require__(174);
	var ReactPropTypeLocations = __webpack_require__(188);
...
/***/ }
/******/ ]);
//# sourceMappingURL=react-console.example.js.map